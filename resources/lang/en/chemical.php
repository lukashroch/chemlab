...
return [
    ...
    "item.move" => "Move selected",
    "item.move.title" => "Move selected chemical item to store",
    "item.move.number" => "Number of selected chemical items to relocate:",
    "item.msg.moved" => "Selected chemicals have been moved.",
    "owner" => "Owner",
    "unit" => "pcs",
