...
//ALTER TABLE `chemicals` ADD `h_pictogram` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL AFTER `description`, ADD `signal_word` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL AFTER `h_symbol`, ADD `h_statement` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL AFTER `signal_word`, ADD `p_statement` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL AFTER `h_statement`;
...
return [
    ...
    'r_statements' => [
        ...
        'R41' => 'R2 - Risk of serious damage to eyes.',
        'R42' => 'R2 - May cause sensitization by inhalation.',
        'R43' => 'R2 - May cause sensitisation by skin contact.',
        'R44' => 'R2 - Risk of explosion if heated under confinement.',
        'R45' => 'R2 - May cause cancer.',
        'R46' => 'R2 - May cause heritable genetic damage.',
        'R48' => 'R2 - Danger of serious damage to health by prolonged exposure.',
        'R49' => 'R2 - May cause cancer by inhalation.',
        'R50' => 'R2 - Very toxic to aquatic organisms.',
        'R51' => 'R2 - Toxic to aquatic organisms.',
        'R52' => 'R2 - Harmful to aquatic organisms.',
        'R53' => 'R2 - May cause long-term adverse effects in the aquatic environment.',
        'R54' => 'R2 - Toxic to flora.',
        'R55' => 'R2 - Toxic to fauna.',
        'R56' => 'R2 - Toxic to soil organisms.',
        'R57' => 'R2 - Toxic to bees.',
        'R58' => 'R2 - May cause long-term adverse effects in the environment.',
        'R59' => 'R2 - Dangerous for the ozone layer.',
        'R60' => 'R2 - May impair fertility.',
        'R61' => 'R2 - May cause harm to the unborn child.',
        'R62' => 'R2 - Possible risk of impaired fertility.',
        'R63' => 'R2 - Possible risk of harm to the unborn child.',
        'R64' => 'R2 - May cause harm to breastfed babies.',
        'R65' => 'R2 - Harmful: may cause lung damage if swallowed.',
        'R66' => 'R2 - Repeated exposure may cause skin dryness or cracking.',
        'R67' => 'R2 - Vapours may cause drowsiness and dizziness.',
        'R68' => 'R2 - Possible risk of irreversible effects.',
        'R 14/15' => 'R2 - Reacts violently with water, liberating extremely flammable gases.',
        'R 15/29' => 'R2 - Contact with water liberates toxic, extremely flammable gas.',
        'R 20/21' => 'R2 - Harmful by inhalation and in contact with skin.',
        'R 20/22' => 'R2 - Harmful by inhalation and if swallowed.',
        'R 21/22' => 'R2 - Harmful in contact with skin and if swallowed.',
        'R 20/21/22' => 'R2 - Harmful by inhalation, in contact with skin and if swallowed.',
        'R 23/24' => 'R2 - Toxic by inhalation and in contact with skin.',
        'R 24/25' => 'R2 - Toxic in contact with skin and if swallowed.',
        'R 23/25' => 'R2 - Toxic by inhalation and if swallowed.',
        'R 23/24/25' => 'R2 - Toxic by inhalation, in contact with skin and if swallowed.',
        'R 26/27' => 'R2 - Very toxic by inhalation and in contact with skin.',
        'R 26/28' => 'R2 - Very toxic by inhalation and if swallowed.',
        'R 26/27/28' => 'R2 - Very toxic by inhalation, in contact with skin and if swallowed.',
        'R 27/28' => 'R2 - Very toxic in contact with skin and if swallowed.',
        'R 36/37' => 'R2 - Irritating to eyes and respiratory system.',
        'R 36/38' => 'R2 - Irritating to eyes and skin.',
        'R 37/38' => 'R2 - Irritating to respiratory system and skin.',
        'R 36/387/38' => 'R2 - Irritating to eyes, respiratory system and skin.',
        'R 39/23' => 'R2 - Toxic: danger of very serious irreversible effects through inhalation.',
        'R 39/24' => 'R2 - Toxic: danger of very serious irreversible effects in contact with skin.',
        'R 39/25' => 'R2 - Toxic: danger of very serious irreversible effects if swallowed.',
        'R 39/32/24' => 'R2 - Toxic: danger of very serious irreversible effects through inhalation  and in contact with skin.',
        'R 39/23/25' => 'R2 - Toxic: danger of very serious irreversible effects through inhalation  and if swallowed.',
        'R 39/24/25' => 'R2 - Toxic: danger of very serious irreversible effects in contact with skin and if swallowed.',
        'R 39/23/24/25' => 'R2 - Toxic: danger of very serious irreversible effects through inhalation,  in contact with skin and if swallowed.',
        'R 39/26' => 'R2 - Very toxic: danger of very serious irreversible effects through inhalation.',
        'R 39/26/27' => 'R2 - Very toxic: danger of very serious irreversible effects through inhalation and in contact with skin.',
        'R 39/27' => 'R2 - Very toxic: danger of very serious irreversible effects in contact with skin.',
        'R 39/28' => 'R2 - Very toxic: danger of very serious irreversible effects if swallowed.',
        'R 39/26/28' => 'R2 - Very toxic: danger of very serious irreversible effects through inhalation and if swallowed.',
        'R 39/27/28' => 'R2 - Very toxic: danger of very serious irreversible effects in contact with skin and if swallowed.',
        'R 39/26/27/28' => 'R2 - Very toxic: danger of very serious irreversible effects through inhalation, in contact with skin and if swallowed.',
        'R 68/20' => 'R2 - Harmful: possible risk of irreversible effects through inhalation.',
        'R 68/21' => 'R2 - Harmful: possible risk of irreversible effects in contact with skin.',
        'R 68/22' => 'R2 - Harmful: possible risk of irreversible effects if swallowed.',
        'R 68/20/21' => 'R2 - Harmful: possible risk of irreversible effects through inhalation  and in contact with skin.',
        'R 68/20/22' => 'R2 - Harmful: possible risk of irreversible effects through inhalation  and if swallowed.',
        'R 68/21/22' => 'R2 - Harmful: possible risk of irreversible effects in contact with skin  and if swallowed.',
        'R 68/20/21/22' => 'R2 - Harmful: possible risk of irreversible effects through inhalation,  in contact with skin and if swallowed.',
        'R 42/43' => 'R2 - May cause sensitization by inhalation and skin contact.',
        'R 48/20' => 'R2 - Harmful: danger of serious damage to health by prolonged exposure through inhalation.',
        'R 48/21' => 'R2 - Harmful: danger of serious damage to health by prolonged exposure in contact with skin.',
        'R 48/22' => 'R2 - Harmful: danger of serious damage to health by prolonged exposure if swallowed.',
        'R 48/20/21' => 'R2 - Harmful: danger of serious damage to health by prolonged exposure through inhalation and in contact with skin.',
        'R 48/20/22' => 'R2 - Harmful: danger of serious damage to health by prolonged exposure through inhalation and if swallowed.',
        'R 48/21/22' => 'R2 - Harmful: danger of serious damage to health by prolonged exposure in contact with skin and if swallowed.',
        'R 48/20/21/22' => 'R2 - Harmful: danger of serious damage to health by prolonged exposure through inhalation, in contact with skin and if swallowed.',
        'R 48/23' => 'R2 -  Toxic: danger of serious damage to health by prolonged exposure through inhalation.',
        'R 48/24' => 'R2 - Toxic: danger of serious damage to health by prolonged exposure in contact with skin.',
        'R 48/25' => 'R2 - Toxic: danger of serious damage to health by prolonged exposure if swallowed.',
        'R 48/23/24' => 'R2 - Toxic: danger of serious damage to health by prolonged exposure through inhalation and in contact with skin.',
        'R 48/23/25' => 'R2 - Toxic: danger of serious damage to health by prolonged exposure through inhalation and if swallowed.',
        'R 48/24/25' => 'R2 - Toxic: danger of serious damage to health by prolonged exposure in contact with skin and if swallowed.',
        'R 48/23/24/25' => 'R2 - Toxic: danger of serious damage to health by prolonged exposure through inhalation, in contact with skin and if swallowed.',
        'R 50/53' => 'R2 - Very toxic to aquatic organisms, may cause long-term adverse effects in the aquatic environment.',
        'R 51/53' => 'R2 - Toxic to aquatic organisms, may cause long-term adverse effects in the aquatic environment.',
        'R 52/53' => 'R2 - Harmful to aquatic organisms, may cause long-term adverse effects in the aquatic environment.'
    ]
];
