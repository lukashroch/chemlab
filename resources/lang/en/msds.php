...
//ALTER TABLE `chemicals` ADD `h-pictogram` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL AFTER `updated_at`, ADD `h-statement` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL AFTER `h-pictogram`, ADD `p-statement` VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL AFTER `h-statement`;
