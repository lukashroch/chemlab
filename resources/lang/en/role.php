...
return [
    ...
    "perms" => "Assigned permissions",
    "perms.none" => "None permission assigned",
    "perms.assigned" => "Permissions currently assigned to the role",
    "perms.not-assigned" => "Available permissions to assign",
    "perms.header" => "Firstly create role to assign permissions",
