        ...
        <div class="card-block" id="chemical-edit">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="structure" role="tabpanel">
              <div class="form-group row">
                {{ Form::label('inchikey', trans('chemical.structure.inchikey'), ['class' => 'col-sm-2 col-form-label']) }}
                <div class="col-sm-10">
              ...
              <div class="form-group row">
                {{ Form::label('inchi', trans('chemical.structure.inchi'), ['class' => 'col-sm-2 col-form-label']) }}
                <div class="col-sm-10">
                  {{ Form::input('text', 'inchi', $chemical->structure ? $chemical->structure->inchi : null, ['id' => 'inchi', 'class' => 'form-control', 'readonly' => 'readonly']) }}
                </div>
              </div>
              <div class="form-group row">
                {{ Form::label('smiles', trans('chemical.structure.smiles'), ['class' => 'col-sm-2 col-form-label']) }}
                <div class="col-sm-10">
              ...
              <div class="form-group row hidden-xs-up">
                {{ Form::label('sdf', trans('chemical.structure.sdf'), ['class' => 'col-sm-2 col-form-label sr-only']) }}
                <div class="col-sm-10">
