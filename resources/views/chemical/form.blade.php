...
@section('title')
  {{ $chemical->name ?? trans('chemical.new') }}
@endsection

@section('content')
  <div class="card" id="chemical">
    @component('resource.header', ['resource' => 'chemical', 'item' => $chemical, 'actions' => isset($chemical->id) ? ['show', 'delete'] : []])
      <li class="nav-item">
        ...
        <div class="tab-pane active" id="info" role="tabpanel">
          ...
          <div class="form-group form-row">
            ...
            <div class="col-md-10">
              ...
              @includeWhen($errors->has('iupac_name'), 'partials.error', ['entry' => 'iupac_name'])
            </div>
          </div>
          <div class="form-group form-row">
            ...
            <div class="col-md-10">
              ...
              @includeWhen($errors->has('synonym'), 'partials.error', ['entry' => 'synonym'])
            </div>
          </div>
          <div class="form-group form-row">
            ...
            <div class="col-md-4">
              ...
              @includeWhen($errors->has('catalog_id'), 'partials.error', ['entry' => 'catalog_id'])
            </div>
            ...
            <div class="col-md-4">
              ...
              @includeWhen($errors->has('brand_id'), 'partials.error', ['entry' => 'brand_id'])
            </div>
          </div>
          <div class="form-group form-row">
            ...
            <div class="col-md-4">
              ...
              @includeWhen($errors->has('cas'), 'partials.error', ['entry' => 'cas'])
            </div>
            ...
            <div class="col-md-4">
              ...
              @includeWhen($errors->has('pubchem'), 'partials.error', ['entry' => 'pubchem'])
            </div>
          </div>
          <div class="form-group form-row">
            ...
            <div class="col-md-4">
              ...
              @includeWhen($errors->has('mw'), 'partials.error', ['entry' => 'mw'])
            </div>
            ...
            <div class="col-md-4">
              ...
              @includeWhen($errors->has('formula'), 'partials.error', ['entry' => 'formula'])
            </div>
          </div>
          <div class="form-group form-row">
            ...
            <div class="col-md-10">
              ...
              @includeWhen($errors->has('chemspider'), 'partials.error', ['entry' => 'chemspider'])
            </div>
          </div>
          <div class="form-group form-row">
        ...
        <div class="tab-pane" id="msds" role="tabpanel">
              ...
              @if(Storage::disk('local')->exists("sds/{$chemical->id}.pdf"))
                <p class="form-control-static">
                  <a href="{{ route('chemical.get-sds', ['chemical' => $chemical->id]) }}">
                    <span class="fas fa-file-pdf-o"></span> {{ trans('msds.sds.get') }}
                  </a>
                </p>
              @endif
            </div>
          ...
          <div class="form-group form-row">
            ...
            <div class="col-md-4">
              ...
              @includeWhen($errors->has('symbol'), 'partials.error', ['entry' => 'symbol'])
            </div>
            ...
            <div class="col-md-4">
              ...
              @includeWhen($errors->has('signal_word'), 'partials.error', ['entry' => 'signal_word'])
            </div>
          </div>
          <div class="form-group form-row">
        ...
        <div class="tab-pane" id="structure" role="tabpanel">
          <div class="form-group form-row">
            ...
            <div class="col-md-10">
              ...
              @includeWhen($errors->has('inchikey'), 'partials.error', ['entry' => 'inchikey'])
            </div>
          </div>
          <div class="form-group form-row">
            ...
            <div class="col-md-10">
              ...
              @includeWhen($errors->has('inchi'), 'partials.error', ['entry' => 'inchi'])
            </div>
          </div>
          <div class="form-group form-row">
            ...
            <div class="col-md-10">
              ...
              @includeWhen($errors->has('smiles'), 'partials.error', ['entry' => 'smiles'])
            </div>
          </div>
