...
@section('title', $chemical->name)

@section('content')
  <div class="card" id="chemical">
    @component('resource.header', ['resource' => 'chemical', 'item' => $chemical, 'actions' => ['edit', 'delete']])
      <li class="nav-item">
      ...
      <div class="tab-pane active" id="info" role="tabpanel">
        <table class="table table-hover">
          ...
          <tr>
            ...
            <td>{{ $chemical->brand->name ?? trans('common.not.specified') }}</td>
          </tr>
          <tr>
