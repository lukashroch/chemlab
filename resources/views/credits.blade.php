    ...
    <div class="col-sm-12">
      <div class="card panel-default">
        ...
        <div class="list-group list-group-flush">
          {{ link_to('http://laravel.com/', 'Laravel - PHP Framework', ['class' => 'list-group-item', 'target' => '_blank', 'rel' => 'noopener']) }}
          {{ link_to('http://jquery.com/', 'jQuery - JS Framework', ['class' => 'list-group-item', 'target' => '_blank', 'rel' => 'noopener']) }}
          {{ link_to('http://getbootstrap.com/', 'Bootstrap - HTML/CSS/JS
            Framework', ['class' => 'list-group-item', 'target' => '_blank', 'rel' => 'noopener']) }}
