<div class="btn-group pull-right">
  ...
  <ul class="dropdown-menu dropdown-menu-left" role="menu" id="action-menu">
    ...
    <li>
      <a class="export" href="{{ $route }}" data-action="excel">
    ...
    {{--<li>
      <a class="export" href="{{ $route }}" data-action="pdf">
