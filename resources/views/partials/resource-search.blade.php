            ...
            <div class="col-sm-10 col-md-5">
              <div class="input-group">
                <span class="input-group-btn">
                  <a id="search-clear" class="btn btn-secondary">
                    <span class="fa fa-rotate-right" title="{{ trans('common.search.clear') }}" aria-hidden="true"></span>
                  </a>
                </span>
                {{ Form::label('s', trans('common.search'), ['class' => 'form-control-label sr-only']) }}
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="collapse" id="search-advanced">
              ...
              <div class="form-group form-group-sm row">
                <label class="col-sm-4 col-md-2 col-form-label">{{ trans('chemical.chemspider') }}</label>
                <div class="col-sm-8 col-md-4">
                  {{ Form::input('text', 'chemspider', Input::get('chemspider'), ['class' => 'form-control', 'placeholder' => trans('chemical.chemspider')]) }}
                </div>
                <label class="col-sm-4 col-md-2 col-form-label">{{ trans('chemical.pubchem') }}</label>
                <div class="col-sm-8 col-md-4">
                  {{ Form::input('text', 'pubchem', Input::get('pubchem'), ['class' => 'form-control', 'placeholder' => trans('chemical.pubchem')]) }}
                </div>
              </div>
              <div class="form-group form-group-sm row">
                <label class="col-sm-4 col-md-2 col-form-label">{{ trans('chemical.formula') }}</label>
                <div class="col-sm-8 col-md-4">
                  {{ Form::input('text', 'formula', Input::get('formula'), ['class' => 'form-control', 'placeholder' => trans('chemical.formula')]) }}
                </div>
                <label class="col-sm-4 col-md-2 col-form-label">{{ trans('chemical.structure.inchikey') }}</label>
                <div class="col-sm-8 col-md-4">
                  <div class="input-group">
